...
public class AdminDashboardController {
    ...
    private void setupHeritageTable() {
    ...
    private void setupArchitectureTable() {
    ...
    private void loadHeritageData() {
        heritageList = FXCollections.observableArrayList(heritageDAO.readAll());
        heritageTable.setItems(heritageList);
    }

    private void loadArchitectureData() {
        architectureList = FXCollections.observableArrayList(architectureDAO.readAll());
        architectureTable.setItems(architectureList);
    }

    @FXML
    private void handleHeritageSearch() {
        String keyword = hSearchField.getText();
        if (keyword == null || keyword.isEmpty()) {
            loadHeritageData();
        } else {
            heritageList = FXCollections.observableArrayList(heritageDAO.search(keyword));
            heritageTable.setItems(heritageList);
        }
    }

    @FXML
    private void handleArchitectureSearch() {
        String keyword = aSearchField.getText();
        if (keyword == null || keyword.isEmpty()) {
            loadArchitectureData();
        } else {
            architectureList = FXCollections.observableArrayList(architectureDAO.search(keyword));
            architectureTable.setItems(architectureList);
        }
    }

    @FXML
    private void handleDeleteHeritage() {
    ...
    @FXML
    private void handleDeleteArchitecture() {
    ...
    // Simplified Add/Edit Dialogs (In a real app, these would be separate FXMLs)
    @FXML
    private void handleAddHeritage() {
    ...
    @FXML
    private void handleAddArchitecture() {
